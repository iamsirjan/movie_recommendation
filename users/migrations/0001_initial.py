    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(blank=True, related_name='movie', to='users.genre')),
                ('language', models.ManyToManyField(blank=True, related_name='movie', to='users.language')),
            ],
        ),
        migrations.CreateModel(
            name='rating',
